...
# form config_file for SOAP

der = path + "04_soap/"
os.chdir(der)
for w in col1:
  out = open("config_" + w + ".txt", 'w')
  out.write(os.path.join("max_rd_len=" + str(sys.argv[3])[1:-1] + "\n[LIB]\n"))
  out.write(os.path.join("rd_len_cutof=" + str(sys.argv[4])[1:-1] + "\n"))
  out.write(os.path.join("avg_ins=" + str(sys.argv[5])[1:-1]+ "\n"))
  out.write(os.path.join("reverse_seq=" + str(sys.argv[6])[1:-1] + "\n"))
  out.write(os.path.join("asm_flags=" + str(sys.argv[7])[1:-1] + "\n"))
  out.write(os.path.join("map_len=" + str(sys.argv[8])[1:-1] + "\n"))
  out.write("q1=" + filt + w + "_1." + end + "\n")
  out.write("q2=" + filt + w + "_2." + end + "\n")
  out.close
